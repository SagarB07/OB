...
static Logger log4j = Logger.getLogger(EndYearCloseUtilityData.class);
  ...
  public static EndYearCloseUtilityData[] getAmounts(ConnectionProvider connectionProvider, String c_year_id, String accounttype, String org, String acctSchema)    throws ServletException {
    return getAmounts(connectionProvider, c_year_id, accounttype, org, acctSchema, 0, 0);
  }

  public static EndYearCloseUtilityData[] getAmounts(ConnectionProvider connectionProvider, String c_year_id, String accounttype, String org, String acctSchema, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static EndYearCloseUtilityData[] getAmountsClose(Connection conn, ConnectionProvider connectionProvider, String c_year_id, String accounttype, String org, String acctSchema)    throws ServletException {
    return getAmountsClose(conn, connectionProvider, c_year_id, accounttype, org, acctSchema, 0, 0);
  }

  public static EndYearCloseUtilityData[] getAmountsClose(Connection conn, ConnectionProvider connectionProvider, String c_year_id, String accounttype, String org, String acctSchema, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT (CASE sign(SUM(AMTACCTDR)-sum(amtacctcr)) WHEN -1 THEN 0 ELSE (SUM(AMTACCTDR)-sum(amtacctcr)) END) AS TOTALAMTCR," +
  ...
  public static EndYearCloseUtilityData[] selectOrg(ConnectionProvider connectionProvider, String rol)    throws ServletException {
    return selectOrg(connectionProvider, rol, 0, 0);
  }

  public static EndYearCloseUtilityData[] selectOrg(ConnectionProvider connectionProvider, String rol, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
