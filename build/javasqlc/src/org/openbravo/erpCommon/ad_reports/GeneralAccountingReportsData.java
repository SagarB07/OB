...
static Logger log4j = Logger.getLogger(GeneralAccountingReportsData.class);
  ...
  public static GeneralAccountingReportsData[] checkFiscalYearsGenLed(ConnectionProvider connectionProvider, String adClientId, String cAcctschemaId)    throws ServletException {
    return checkFiscalYearsGenLed(connectionProvider, adClientId, cAcctschemaId, 0, 0);
  }

  public static GeneralAccountingReportsData[] checkFiscalYearsGenLed(ConnectionProvider connectionProvider, String adClientId, String cAcctschemaId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT CASE WHEN C.CLOSE_FACT_ACCT_GROUP_ID IS NULL THEN 'N' ELSE 'Y' END || SELECTED.C_YEAR_ID AS ID," +
      "          C_YEAR.YEAR AS NAME" +
