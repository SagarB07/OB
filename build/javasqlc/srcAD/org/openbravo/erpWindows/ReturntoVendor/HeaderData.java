 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO C_Order " +
      "        (RM_PickFromShipment, DocAction, AD_Org_ID, C_DocTypeTarget_ID, Generatetemplate, DocumentNo, POReference, DateOrdered, C_BPartner_ID, C_BPartner_Location_ID, C_Return_Reason_ID, M_Warehouse_ID, DatePromised, FIN_Paymentmethod_ID, RM_ReceiveMaterials, C_PaymentTerm_ID, RM_CreateInvoice, M_PriceList_ID, DocStatus, GrandTotal, TotalLines, C_Currency_ID, AD_User_ID, C_Project_ID, Deliverynotes, Description, SalesRep_ID, BillTo_ID, C_Incoterms_ID, Incotermsdescription, IsDiscountPrinted, C_DocType_ID, FreightAmt, DeliveryViaRule, M_Shipper_ID, PriorityRule, ChargeAmt, C_Charge_ID, FreightCostRule, CopyFrom, CopyFromPO, RM_AddOrphanLine, C_Activity_ID, C_Campaign_ID, AD_OrgTrx_ID, User1_ID, User2_ID, DeliveryRule, IsDelivered, IsSelfService, IsInvoiced, PaymentRule, AD_Client_ID, IsSelected, IsActive, IsPrinted, DatePrinted, DropShip_User_ID, Delivery_Location_ID, InvoiceRule, DateAcct, Posted, IsSOTrx, C_Order_ID, Processed, IsTaxIncluded, DropShip_Location_ID, DropShip_BPartner_ID, Processing, created, createdby, updated, updatedBy)" +
