 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , C_Doctype_ID = (?) , DocumentNo = (?) , DateAcct = TO_DATE(?) , FIN_Doubtful_Debt_Run_ID = (?) , FIN_Payment_Schedule_ID = (?) , Description = (?) , Amount = TO_NUMBER(?) , Isactive = (?) , Posted = (?) , C_Bpartner_ID = (?) , M_Product_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , C_Campaign_ID = (?) , C_Activity_ID = (?) , User1_ID = (?) , User2_ID = (?) , EM_APRM_Process = (?) , A_Asset_ID = (?) , C_Currency_ID = (?) , Processing = (?) , FIN_Doubtful_Debt_ID = (?) , AD_Client_ID = (?) , Processed = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Doctype_ID, DocumentNo, DateAcct, FIN_Doubtful_Debt_Run_ID, FIN_Payment_Schedule_ID, Description, Amount, Isactive, Posted, C_Bpartner_ID, M_Product_ID, C_Project_ID, C_Costcenter_ID, C_Campaign_ID, C_Activity_ID, User1_ID, User2_ID, EM_APRM_Process, A_Asset_ID, C_Currency_ID, Processing, FIN_Doubtful_Debt_ID, AD_Client_ID, Processed, created, createdby, updated, updatedBy)" +
