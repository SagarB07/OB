 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Isactive, FIN_Financial_Account_ID, DocumentNo, C_Doctype_ID, Widget, Dateto, Statementdate, Printdetailed, EM_APRM_PrintDetailed, Startingbalance, Endingbalance, EM_APRM_PrintSummary, Printsummary, Docstatus, Processing, Processed, Posted, EM_APRM_Process_Reconciliation, EM_Aprm_Process_Rec, AD_Client_ID, FIN_Reconciliation_ID, created, createdby, updated, updatedBy)" +
