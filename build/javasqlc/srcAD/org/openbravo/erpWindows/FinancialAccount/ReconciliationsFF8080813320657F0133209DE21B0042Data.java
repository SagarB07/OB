 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Isactive = (?) , FIN_Financial_Account_ID = (?) , DocumentNo = (?) , C_Doctype_ID = (?) , Widget = (?) , Dateto = TO_DATE(?) , Statementdate = TO_DATE(?) , EM_APRM_PrintDetailed = (?) , Startingbalance = TO_NUMBER(?) , Printdetailed = (?) , EM_APRM_PrintSummary = (?) , Endingbalance = TO_NUMBER(?) , Printsummary = (?) , Docstatus = (?) , Processing = (?) , Processed = (?) , Posted = (?) , EM_APRM_Process_Reconciliation = (?) , EM_Aprm_Process_Rec = (?) , AD_Client_ID = (?) , FIN_Reconciliation_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE FIN_Reconciliation.FIN_Reconciliation_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Isactive, FIN_Financial_Account_ID, DocumentNo, C_Doctype_ID, Widget, Dateto, Statementdate, EM_APRM_PrintDetailed, Startingbalance, Printdetailed, EM_APRM_PrintSummary, Endingbalance, Printsummary, Docstatus, Processing, Processed, Posted, EM_APRM_Process_Reconciliation, EM_Aprm_Process_Rec, AD_Client_ID, FIN_Reconciliation_ID, created, createdby, updated, updatedBy)" +
