 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_Inventory" +
      "        SET AD_Org_ID = (?) , MovementDate = TO_DATE(?) , Name = (?) , M_Warehouse_ID = (?) , Description = (?) , GenerateList = (?) , EM_Co_Inventario = (?) , UpdateQty = (?) , Processing = (?) , Posted = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , C_Activity_ID = (?) , User1_ID = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , User2_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , M_Inventory_ID = (?) , Processed = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, MovementDate, Name, M_Warehouse_ID, Description, GenerateList, EM_Co_Inventario, UpdateQty, Processing, Posted, C_Project_ID, C_Costcenter_ID, A_Asset_ID, C_Activity_ID, User1_ID, C_Campaign_ID, AD_OrgTrx_ID, User2_ID, IsActive, AD_Client_ID, M_Inventory_ID, Processed, created, createdby, updated, updatedBy)" +
