...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return documentno;
    else if (fieldName.equalsIgnoreCase("em_co_nro_cheque") || fieldName.equals("emCoNroCheque"))
      return emCoNroCheque;
    ...
    else if (fieldName.equalsIgnoreCase("em_co_nombre_banco") || fieldName.equals("emCoNombreBanco"))
      return emCoNombreBanco;
 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "FIN_Payment.EM_Co_Nombre_Banco, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.emCoNroCheque = UtilSql.getValue(result, "em_co_nro_cheque");
        ...
        objectHeaderData.emCoNombreBanco = UtilSql.getValue(result, "em_co_nombre_banco");
 ...
 */
  public static HeaderData[] set(String finFinancialAccountId, String cCostcenterId, String createdbyalgorithm, String finaccTxnConvertRate, String finaccTxnAmount, String finPaymentId, String adClientId, String adOrgId, String createdby, String createdbyr, String updatedby, String updatedbyr, String isactive, String isreceipt, String cBpartnerId, String cBpartnerIdr, String paymentdate, String cCurrencyId, String amount, String writeoffamt, String documentno, String referenceno, String status, String processed, String processing, String posted, String postedBtn, String finPaymentmethodId, String emAprmProcessPayment, String emAprmProcessPaymentBtn, String emAprmReconcilePayment, String emCoNombreBanco, String emAprmAddScheduledpayments, String cDoctypeId, String cProjectId, String cProjectIdr, String cCampaignId, String cActivityId, String user1Id, String user2Id, String emAprmExecutepayment, String description, String generatedCredit, String usedCredit, String emAprmReversepayment, String finRevPaymentId, String emCoNroCheque)    throws ServletException {
    ...
    objectHeaderData[0].emCoNroCheque = emCoNroCheque;
    ...
    objectHeaderData[0].emCoNombreBanco = emCoNombreBanco;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE FIN_Payment" +
      "        SET AD_Org_ID = (?) , C_DocType_ID = (?) , DocumentNo = (?) , EM_Co_Nro_Cheque = (?) , Referenceno = (?) , Paymentdate = TO_DATE(?) , C_Bpartner_ID = (?) , Description = (?) , Fin_Paymentmethod_ID = (?) , Fin_Financial_Account_ID = (?) , C_Currency_ID = (?) , Finacc_Txn_Amount = TO_NUMBER(?) , Finacc_Txn_Convert_Rate = TO_NUMBER(?) , Generated_Credit = TO_NUMBER(?) , EM_Co_Nombre_Banco = (?) , EM_Aprm_Add_Scheduledpayments = (?) , Posted = (?) , EM_APRM_Process_Payment = (?) , EM_Aprm_Executepayment = (?) , Amount = TO_NUMBER(?) , Status = (?) , Used_Credit = TO_NUMBER(?) , Writeoffamt = TO_NUMBER(?) , EM_APRM_ReversePayment = (?) , FIN_Rev_Payment_ID = (?) , CreatedByAlgorithm = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , C_Activity_ID = (?) , C_Campaign_ID = (?) , User1_ID = (?) , User2_ID = (?) , EM_APRM_Reconcile_Payment = (?) , Isactive = (?) , Fin_Payment_ID = (?) , AD_Client_ID = (?) , Processed = (?) , Processing = (?) , Isreceipt = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emCoNroCheque);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emCoNombreBanco);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_DocType_ID, DocumentNo, EM_Co_Nro_Cheque, Referenceno, Paymentdate, C_Bpartner_ID, Description, Fin_Paymentmethod_ID, Fin_Financial_Account_ID, C_Currency_ID, Finacc_Txn_Amount, Finacc_Txn_Convert_Rate, Generated_Credit, EM_Co_Nombre_Banco, EM_Aprm_Add_Scheduledpayments, Posted, EM_APRM_Process_Payment, EM_Aprm_Executepayment, Amount, Status, Used_Credit, Writeoffamt, EM_APRM_ReversePayment, FIN_Rev_Payment_ID, CreatedByAlgorithm, C_Project_ID, C_Costcenter_ID, C_Activity_ID, C_Campaign_ID, User1_ID, User2_ID, EM_APRM_Reconcile_Payment, Isactive, Fin_Payment_ID, AD_Client_ID, Processed, Processing, Isreceipt, created, createdby, updated, updatedBy)" +
