 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_BPartner_ID = (?) , M_PriceList_ID = (?) , GenerateOrder = (?) , C_Incoterms_ID = (?) , Incoterms_Description = (?) , Note = (?) , C_Project_Vendor_ID = (?) , M_PriceList_Version_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , IsActive = (?) , C_Project_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Project_Vendor.C_Project_Vendor_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_BPartner_ID, M_PriceList_ID, GenerateOrder, C_Incoterms_ID, Incoterms_Description, Note, C_Project_Vendor_ID, M_PriceList_Version_ID, AD_Client_ID, AD_Org_ID, IsActive, C_Project_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
