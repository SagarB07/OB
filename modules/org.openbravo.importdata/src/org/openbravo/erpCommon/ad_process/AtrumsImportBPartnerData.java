...
public class AtrumsImportBPartnerData implements FieldProvider {
	static Logger log4j = Logger.getLogger(AtrumsImportBPartnerData.class);
	  ...
	  public String em_idt_firstname; 
	  public String em_idt_lastname;
	  ...
	  public String getInitRecordNumber() {
		  ...
		  public String getField(String fieldName) {
			if (fieldName.equalsIgnoreCase("em_idt_firstname") || fieldName.equals("em_idt_firstname"))
			      return em_idt_firstname;
			  
			if (fieldName.equalsIgnoreCase("em_idt_lastname") || fieldName.equals("em_idt_lastname"))
			      return em_idt_lastname;
		  ...
		  public static AtrumsImportBPartnerData[] select(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
		    return select(connectionProvider, ad_client_id, 0, 0);
		  }

		  public static AtrumsImportBPartnerData[] select(ConnectionProvider connectionProvider, String ad_client_id, int firstRegister, int numberRegisters)    throws ServletException {
		    String strSql = "";
		    strSql = strSql + 
		      "        SELECT I_BPartner_ID, C_BPartner_ID, C_BPartner_Location_ID," +
		      "        COALESCE (Address1,Address2,City) AS Addr, AD_User_ID, ContactName," +
		      "		Address1, Address2, City, Postal, RegionName, em_idt_firstname, em_idt_lastname" +
		      "			  FROM I_BPartner" +
		    ...
		    st = connectionProvider.getPreparedStatement(strSql);
		      ...
		      while(continueResult && result.next()) {
		        countRecord++;
		        AtrumsImportBPartnerData objectImportBPartnerData = new AtrumsImportBPartnerData();
		        objectImportBPartnerData.em_idt_firstname = UtilSql.getValue(result, "em_idt_firstname");
		        objectImportBPartnerData.em_idt_lastname = UtilSql.getValue(result, "em_idt_lastname");
		    ...
		    AtrumsImportBPartnerData objectImportBPartnerData[] = new AtrumsImportBPartnerData[vector.size()];
