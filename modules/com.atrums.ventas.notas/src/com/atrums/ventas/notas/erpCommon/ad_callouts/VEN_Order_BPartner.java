 ...
 ************************************************************************
 */
package com.atrums.ventas.notas.erpCommon.ad_callouts;
...
public class VEN_Order_BPartner extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strBPartner,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/ventas/notas/erpCommon/ad_callouts/CallOut").createXmlDocument();
    String strDeliveryRule, strPaymentrule, strPaymentterm, strMwarehouse, strInvoiceRule, strPriceList, strUserRep, strDeliveryViaRule, strFinPaymentMethodId, strNote;
    strDeliveryRule = strPaymentrule = strPaymentterm = strMwarehouse = strInvoiceRule = strPriceList = strUserRep = strDeliveryViaRule = strFinPaymentMethodId = strNote = "";
    ...
    if (data != null && data.length > 0) {
      ...
      strUserRep = VENOrderBPartnerData.userIdSalesRep(this, data[0].salesrepId);
      ...
      if (strPriceList.equalsIgnoreCase("")) {
        strPriceList = VENOrderBPartnerData.defaultPriceList(this, strIsSOTrx, vars.getClient());
      }
    ...
    strMwarehouse = VENOrderBPartnerData.mWarehouse(this, strBPartner);
    ...
    resultado.append("var calloutName='VEN_Order_BPartner';\n\n");
    ...
    resultado.append("new Array(\"inpisdiscountprinted\", \""
        + VENOrderBPartnerData.getIsDicountPrinted(this, strBPartner) + "\"),");
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
          "C_Order DeliveryRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
              "SEOrderBPartner"),
          Utility.getContext(this, vars, "#User_Client", "VENOrderBPartner"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "VENOrderBPartner", "");
      l = comboTableData.select(false);
      comboTableData = null;
    } catch (Exception ex) {
      throw new ServletException(ex);
	...
	strNote = VENOrderBPartnerData.getNota(this, strBPartner);
	
	if (strNote != null && !strNote.equals("")) {
      resultado.append(", new Array(\"inpemVenNota\", \"" + strNote + "\")");
    }
