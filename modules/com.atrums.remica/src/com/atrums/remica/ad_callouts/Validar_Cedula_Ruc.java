...
public class Validar_Cedula_Ruc extends HttpSecureAppServlet {
  ...
  */
	...
	if (vars.commandIn("DEFAULT"))
	{
	    ...
	    String stremCoTipoIdentificacion = vars
		    .getStringParameter("inpemCoTipoIdentificacion");

	    try
	    {
		if (strtaxid != null)
		    printPage(response, vars, strtaxid,
			      stremCoTipoIdentificacion);
	    }
    ...
    private void printPage(HttpServletResponse response,
	    VariablesSecureApp vars, String strtaxid,
	    String stremCoTipoIdentificacion) throws IOException,
	    ServletException
    {
	...
	if (!mensaje.equals(""))
	{
	    ...
	    // FIN
	    result.append("var calloutName='Validar_Cedula_Ruc';\n\n");
    ...
    private String validarDocumento(VariablesSecureApp vars, String numero,
