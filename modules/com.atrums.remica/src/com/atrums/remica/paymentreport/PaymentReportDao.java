...
package com.atrums.remica.paymentreport;
...
public class PaymentReportDao {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        if (FIN_PaymentScheduleDetail[i].getInvoicePaymentSchedule() != null) {
          ...
          if (invoices.size() == 1) {
            ...
            // direccion
            FieldProviderFactory.setField(data[i], "DIRECCION", "");
  ...
  private FieldProvider createFieldProviderForTransaction(FIN_FinaccTransaction transaction,
    ...
    // DIRECCION
    FieldProviderFactory.setField(transactionData, "DIRECCION", "");
    // project
  ...
  private void fillLine(SimpleDateFormat dateFormat, FieldProvider data,
    ...
    // direccion
    if (paymentSchedule.getInvoice().getPartnerAddress() != null)
      FieldProviderFactory.setField(data, "DIRECCION", paymentSchedule.getInvoice()
          .getPartnerAddress().getIdentifier());

    else
      FieldProviderFactory.setField(data, "DIRECCION", "");
