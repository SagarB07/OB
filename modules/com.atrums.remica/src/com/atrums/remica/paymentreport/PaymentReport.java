...
public class PaymentReport extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.commandIn("FIND", "DIRECT")) {
      ...
      try {
        ...
        xmlDocument = xmlEngine.readXmlTemplate("com/atrums/remica/paymentreport/PaymentReport",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.atrums.remica.paymentreport.PaymentReport");
  ...
  private void printPage(HttpServletRequest request, HttpServletResponse response,
    ...
    if (strOutput.equals("pdf")) {
      ...
      strReportName = "@basedesign@/com/atrums/remica/paymentreport/PaymentReportPDF.jrxml";
      response.setHeader("Content-disposition", "inline; filename=PaymentReport.pdf");
    } else if (strOutput.equals("xls")) {
      strReportName = "@basedesign@/com/atrums/remica/paymentreport/PaymentReportExcel.jrxml";
