...
public class LocationCity extends HttpSecureAppServlet {
  ...
  private void printPageKey(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/contabilidad/erpCommon/info/SearchUniqueKeyResponse").createXmlDocument();
  ...
  private void printPageFS(HttpServletResponse response, VariablesSecureApp vars)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/contabilidad/erpCommon/info/Location_FS").createXmlDocument();
  ...
  private void printPageSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (strcLocationId.equals("")) {
      xmlDocument = xmlEngine.readXmlTemplate("com/atrums/contabilidad/erpCommon/info/Location_F1")
          .createXmlDocument();
  ...
  private void printPageF2(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/contabilidad/erpCommon/info/Location_F2").createXmlDocument();
    // Getcountry; default
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Region_ID", "",
  ...
  private void printPageF3(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/contabilidad/erpCommon/info/Location_F3").createXmlDocument();
