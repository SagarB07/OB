 ...
 */
public class CO_Payment_FinAccount extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    String isreceipt = info.getStringParameter("inpisreceipt", null);
	String finPaymentMethod = info.getStringParameter("inpfinPaymentmethodId", null);
    ...
    if (financialAccount != null) {
      ...
      if ((financialAccount.getCoNumeroChequeDesde() != null)
          && (financialAccount.getCoNumeroChequeHasta() != null) && (isreceipt.equals("N")) && (finPaymentMethod.equals("085B35B943F347378983F5F0F316722C"))) {
        ...
        if (financialAccount.getCoNumeroChequeAhora() != null) {
          ...
          if (intActual < intDesde || intActual > intHasta) {
            info.addResult("ERROR", "Número de cheque esta fuera del rango");
          } else {
            info.addResult("inpemCoNroCheque", intActual.toString());
          }
        } else {
          info.addResult("inpemCoNroCheque", intDesde.toString());
        }
      } else {
        info.addResult("inpemCoNroCheque", "");
      }
