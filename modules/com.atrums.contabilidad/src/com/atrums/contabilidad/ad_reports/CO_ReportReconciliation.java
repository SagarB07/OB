...
public class CO_ReportReconciliation extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      printPageDataPDF(request, response, vars, strFinReconciliationID, strFinFinancialAccountId,
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
      ...
      String strFinFinancialAccountName, String strDateTo, String strReportType)
      throws IOException, ServletException {
    log4j.debug("Output: Reconciliation PDF report");

    String reportType = (strReportType == null) ? "DETAIL" : strReportType;

    String strMainReportName = "@basedesign@/com/atrums/contabilidad/ad_reports/ReportReconciliation.jrxml";
    ...
    try {
      JasperDesign jasperDesignLines = JRXmlLoader.load(strBaseDesign
          + "/com/atrums/contabilidad/ad_reports/OutstandingPayment.jrxml");
      ...
      jasperDesignLines = JRXmlLoader.load(strBaseDesign
          + "/com/atrums/contabilidad/ad_reports/OutstandingDeposit.jrxml");
      subReportOutstandingDeposit = JasperCompileManager.compileReport(jasperDesignLines);

      jasperDesignLines = JRXmlLoader.load(strBaseDesign
          + "/com/atrums/contabilidad/ad_reports/UnreconciledBankStatement.jrxml");
      subReportUnreconciledBankStatementLines = JasperCompileManager
          .compileReport(jasperDesignLines);

      strBalance = ReportReconciliationData.select(this, strFinFinancialAccountId, reconciliation
    ...
    parameters.put("ACC_BAL_OB", BigDecimal.valueOf(Double.valueOf(strBalance))); // parameters.put("ACC_BAL_OB",
                                                                                  // accountBalanceOB);
                                                                                  // //
    // Línea Cambiada
