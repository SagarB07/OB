...
public class ATSValidarCedulaRuc extends HttpSecureAppServlet {
  ...
  */
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        if (stridentificacion != null)
          printPage(response, vars, stridentificacion, strtipoIdentificacion);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
      String stridentificacion, String strtipoIdentificacion) throws IOException, ServletException {
    ...
    mensaje = validarDocumento(vars, stridentificacion, strtipoIdentificacion); // Llama
    // al
    // metodo
    // de
    // validación
    ...
    if (!mensaje.equals("")) {
      ...
      strConvRateErrorMsg = cadena + stridentificacion + mensaje;
      // FIN
      result.append("var calloutName='ATSValidarCedulaRuc';\n\n");
      result.append("var respuesta = new Array(new Array(\"MESSAGE\", ");
      result.append("\"" + " " + strConvRateErrorMsg + "\"),");

      result.append("new Array(\"inpidentificacion\", \"" + "" + "\")");
      result.append(");");

    } else {
      result.append("var calloutName='ATSValidarCedulaRuc';\n\n");
      result.append("var respuesta = new Array(");
      // result.append("new Array(\"inpvalue\", \"" + stridentificacion.trim() + "\")");
      result.append(");");
    }
