...
public class Report
{
    ...
    public Report(ConnectionProvider connectionProvider,
	    ...
	    String templateId, boolean multiReport,
	    OutputTypeEnum outputTypeString) throws ReportingException,
	    ServletException
    {
	...
	{
	    case RETENCION: // Retrieve quotation information
		reportData = ReportData.getRetencionInfo(connectionProvider,
							 documentId);
		break;
	    case MOVIMIENTO:
		reportData = ReportData.getMovimientoInfo(connectionProvider,
							  documentId);
		break;
	    default:
	...
	{
	    reportFilename = UUID.randomUUID().toString() + "_"
		    + reportFilename;
	    setDeleteable(true);
	}
