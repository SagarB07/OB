 ...
 * ***********************************************************************
 */
package com.atrums.direccion.erpCommon.info;
...
public class LocationCity extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      vars.getRequestGlobalVariable("inpIDValue", "LocationCity.inpcLocationId");
      // String strcLocationId =
      // vars.getRequestGlobalVariable("inpNameValue",
      // "LocationCity.inpcLocationId");
      String windowId = vars.getRequestGlobalVariable("WindowID", "LocationCity.inpwindowId");
      String adOrgId = vars.getGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID", "");
      if (!"".equals(adOrgId)) {
        vars.setSessionValue("LocationCity.inpadOrgId", adOrgId);
      }
      printPageFS(response, vars);
    } else if (vars.commandIn("KEY")) {
      String strcLocationId = vars.getStringParameter("inpIDValue");
      // String strcLocationId =
      // vars.getStringParameter("inpNameValue");
      ...
      if (data != null && data.length == 1) {
        ...
        vars.setSessionValue("LocationCity.inpcLocationId", strcLocationId);
        vars.getRequestGlobalVariable("inpwindowId", "LocationCity.inpwindowId");
        printPageFS(response, vars);
      }
    } else if (vars.commandIn("FRAME1")) {
      String strcLocationId = vars.getSessionValue("LocationCity.inpcLocationId");
      vars.removeSessionValue("LocationCity.inpcLocationId");
      String strWindow = vars.getSessionValue("LocationCity.inpwindowId");
      vars.removeSessionValue("LocationCity.inpwindowId");
      String stradOrgId = vars.getSessionValue("LocationCity.inpadOrgId");
      vars.removeSessionValue("LocationCity.inpadOrgId");
      ...
      // Obtener ciudades
    } else if (vars.commandIn("OBTENER_ARRAY_CITY")) {
  ...
  private void printPageKey(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/direccion/erpCommon/info/SearchUniqueKeyResponse").createXmlDocument();
  ...
  private void printPageFS(HttpServletResponse response, VariablesSecureApp vars)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/direccion/erpCommon/info/Location_FS").createXmlDocument();
  ...
  private void printPageSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (strcLocationId.equals("")) {
      xmlDocument = xmlEngine.readXmlTemplate("com/atrums/direccion/erpCommon/info/Location_F1")
          .createXmlDocument();
      xmlDocument.setParameter("Command", "NEW");
      // data = LocationSearchData.set(Utility.getDefault(this, vars,
      // "C_Country_ID", "",
      // strWindow,""));
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_City_ID", "",
          "C_Ciudad de Region", Utility.getReferenceableOrg(vars, vars.getOrg()),
          Utility.getContext(this, vars, "#User_Client", strWindow), 0);
  ...
  private void printPageF2(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/direccion/erpCommon/info/Location_F2").createXmlDocument();
    // Getcountry; default
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Region_ID", "",
    ...
    try {
      ...
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_City_ID", "",
          ...
          Utility.getContext(this, vars, "#User_Client", strWindow), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, strWindow, "");
      xmlDocument.setParameter("arrayCity",
          Utility.arrayEntradaSimple("citys", comboTableData.select(false)));
  ...
  private void printPageF3(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/direccion/erpCommon/info/Location_F3").createXmlDocument();

    // Getcountry; default
    try {

      LocationCityData[] data = LocationCityData.select(this, strcRegionId);
      xmlDocument.setParameter("arrayCity",

      Utility.arrayEntradaSimple("citys", data));
