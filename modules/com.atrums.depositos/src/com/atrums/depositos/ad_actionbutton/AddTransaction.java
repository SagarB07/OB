...
package com.atrums.depositos.ad_actionbutton;
...
import com.atrums.depositos.dao.AdvPaymentMngtDao;
...
public class AddTransaction extends HttpSecureAppServlet {
    ...
    try {
      ...
      if (strTransactionType.equals("P")) { // Payment
        ...
        for (FIN_Payment p : selectedPayments) {
          ...
          FIN_FinaccTransaction finTrans = dao.getNewFinancialTransaction(p.getOrganization(), account, TransactionsDao.getTransactionMaxLineNo(account) + 10, p,
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strOrgId,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/depositos/ad_actionbutton/AddTransaction").createXmlDocument();
  ...
  private void printGrid(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/atrums/depositos/ad_actionbutton/AddTransactionGrid").createXmlDocument();
