...
public class NO_ImportaSueldo extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,String strIbPartner) throws IOException, ServletException,
    ...
    // Obtener la fecha de inicio a partir de la consulta SQL
     String sueldo = NOImportaSueldoData.select(this, strIbPartner);
 //   String strFechaInicioCon = NOValidafondosdereservaData.select(this, strcBpartnerId);
     ...
     StringBuffer resultado = new StringBuffer();
      resultado.append("var calloutName='NO_ImportaSueldo';\n\n");
      resultado.append("var respuesta = new Array(");
      resultado.append("new Array(\"inpsueldo\",\"" + sueldo + "\")");
      resultado.append(");");
