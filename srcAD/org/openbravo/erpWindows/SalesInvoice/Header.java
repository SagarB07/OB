...
String stradTableId = "318";
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Atecfe_Docaction152F2390FF594AD9822308A0AABC145C(response, vars, strC_Invoice_ID, stremAtecfeDocaction, strProcessing);
        }
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(HeaderData.selectDef0445FEDA79A747C48A7B3EF852D176DC(this, Utility.getContext(this, vars, "#AD_Org_ID", windowId), Utility.getContext(this, vars, "AD_Role_ID", "167"), Utility.getContext(this, vars, "#AD_Client_ID", windowId)), Utility.getDefault(this, vars, "LastCalculatedOnDate", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Withholding_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Withholdingamount", "", "167", "", dataField), Utility.getDefault(this, vars, "Taxdate", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Atecfe_Docaction", "PR", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "23FC4FD90F7F4E738E615DBB40A04F2D", Utility.getDefault(this, vars, "EM_Atecfe_Docaction", "PR", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "23FC4FD90F7F4E738E615DBB40A04F2D", Utility.getDefault(this, vars, "EM_Atecfe_Docaction", "PR", "167", "N", dataField))), Utility.getDefault(this, vars, "Em_Atecfe_Menobserror_Sri", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Co_Nro_Estab", "", "167", "", dataField), Utility.getDefault(this, vars, "DaysTillDue", "0", "167", "0", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "167", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "167", "", dataField), "Y", Utility.getDefault(this, vars, "Created", "", "167", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "167", "", dataField), HeaderData.selectDef3489_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "167", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "167", "", dataField), HeaderData.selectDef3491_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "167", "", dataField)), Utility.getDefault(this, vars, "DocumentNo", "", "167", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "0", "167", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "167", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "167", "N", dataField))), Utility.getDefault(this, vars, "Processing", "", "167", "N", dataField), Utility.getDefault(this, vars, "Processed", "", "167", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "167", "", dataField), HeaderData.selectDef3499_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "167", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "167", "0", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "167", "0", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "167", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "167", "", dataField), HeaderData.selectDef3510_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "167", "N", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Description", "", "167", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "@#Date@", "167", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "167", "", dataField), Utility.getDefault(this, vars, "POReference", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "167", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "P", "167", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "167", "", dataField), HeaderData.selectDef4247_4(this, Utility.getDefault(this, vars, "C_Order_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "DateOrdered", "", "167", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "167", "N", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Atecfe_Docstatus", "PD", "167", "", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "167", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "167", "N", dataField))), Utility.getDefault(this, vars, "GenerateTo", "", "167", "N", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Co_Punto_Emision", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_APRM_Addpayment", "Y", "167", "N", dataField), Utility.getDefault(this, vars, "FIN_Paymentmethod_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "CopyFrom", "", "167", "N", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "167", "N", dataField))), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Atecfe_Codigo_Acc", "", "167", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Finalsettlement", "", "167", "", dataField), Utility.getDefault(this, vars, "Daysoutstanding", "", "167", "", dataField), Utility.getDefault(this, vars, "Percentageoverdue", "", "167", "", dataField), Utility.getDefault(this, vars, "Totalpaid", "0", "167", "0", dataField), Utility.getDefault(this, vars, "OutstandingAmt", "0", "167", "0", dataField), Utility.getDefault(this, vars, "DueAmt", "0", "167", "0", dataField), Utility.getDefault(this, vars, "EM_Co_Nro_Aut_Sri", "", "167", "", dataField), Utility.getDefault(this, vars, "Ispaid", "N", "167", "N", dataField), Utility.getDefault(this, vars, "UpdatePaymentMonitor", "N", "167", "N", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Calculate_Promotions", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Atecfe_C_Invoice_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Co_Vencimiento_Aut_Sri", "", "167", "", dataField));
...
xmlDocument.setParameter("array", dact.toString());
    ...
    void printPageButtonEM_Atecfe_Docaction152F2390FF594AD9822308A0AABC145C(HttpServletResponse response, VariablesSecureApp vars, String strC_Invoice_ID, String stremAtecfeDocaction, String strProcessing)
    throws IOException, ServletException {
