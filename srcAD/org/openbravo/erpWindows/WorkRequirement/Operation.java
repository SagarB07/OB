...
vars.getGlobalVariable("inpmaWorkrequirementId", windowId + "|MA_Workrequirement_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Wrphase_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|MA_Wrphase_ID", data[0].getField("maWrphaseId"));
    }
