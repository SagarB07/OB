...
vars.getRequestGlobalVariable("inpParamDocumentno", tabId + "|paramDocumentno");
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strNO_Contrato_Empleado_ID, TableSQLData tableSQL)
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "ContratoEmpleado0C51ECCEBC5F448FA60FF1A7DE775ED9", false, "document.frmMain.inpnoContratoEmpleadoId", "grid", "..", "".equals("Y"), "ContratoEmpleado", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strNO_Contrato_Empleado_ID, TableSQLData tableSQL)
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "ContratoEmpleado0C51ECCEBC5F448FA60FF1A7DE775ED9", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpnoContratoEmpleadoId", "", "..", "".equals("Y"), "ContratoEmpleado", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strNO_Contrato_Empleado_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
