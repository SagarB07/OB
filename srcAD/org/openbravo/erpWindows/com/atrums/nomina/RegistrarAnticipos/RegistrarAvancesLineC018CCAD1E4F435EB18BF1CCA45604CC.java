...
comboTableData = new ComboTableData(vars, this, "19", "NO_Tipo_Ingreso_Egreso_ID", "", "FFB3431D5C0141D492402AE5A6A7BAF7", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
comboTableData = new ComboTableData(vars, this, "19", "C_Doctype_ID", "", "DFA36A04B39E4C1CB4774112B41E1352", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
