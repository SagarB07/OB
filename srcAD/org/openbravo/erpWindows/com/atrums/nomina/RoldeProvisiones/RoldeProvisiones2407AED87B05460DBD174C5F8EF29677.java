...
public class RoldeProvisiones2407AED87B05460DBD174C5F8EF29677 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.class);
  
  private static final String windowId = "41844ED4F6D346868D4B5D5F1D4AA14D";
  private static final String tabId = "2407AED87B05460DBD174C5F8EF29677";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDocumentno", tabId + "|paramDocumentno");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strNO_Rol_Pago_Provision_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.view", strView);
        }
      }
      ...
      String strNO_Rol_Pago_Provision_ID = vars.getGlobalVariable("inpnoRolPagoProvisionId", windowId + "|NO_Rol_Pago_Provision_ID", "");
      vars.setSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|RoldeProvisiones2407AED87B05460DBD174C5F8EF29677.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|NO_Rol_Pago_Provision_ID");
      ...
      String strNO_Rol_Pago_Provision_ID = vars.getRequiredStringParameter("inpnoRolPagoProvisionId");
      //RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.delete(this, strNO_Rol_Pago_Provision_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "docstatus", strdocstatus, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data data = new RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data();
    ServletException ex = null;
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.noAreaEmpresaId = vars.getStringParameter("inpnoAreaEmpresaId");     data.noAreaEmpresaIdr = vars.getStringParameter("inpnoAreaEmpresaId_R");     data.cBpartnerId = vars.getRequiredGlobalVariable("inpcBpartnerId", windowId + "|C_Bpartner_ID");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.emNeNumContrato = vars.getStringParameter("inpemNeNumContrato");     data.cDoctypeId = vars.getRequiredStringParameter("inpcDoctypeId");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");    try {   data.totalNeto = vars.getRequiredNumericParameter("inptotalNeto");  } catch (ServletException paramEx) { ex = paramEx; }     data.docstatus = vars.getRequiredGlobalVariable("inpdocstatus", windowId + "|Docstatus");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.docaccionno = vars.getRequiredGlobalVariable("inpdocaccionno", windowId + "|Docaccionno");     data.payment = vars.getRequiredStringParameter("inppayment");    try {   data.totalIngreso = vars.getNumericParameter("inptotalIngreso");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.totalEgreso = vars.getNumericParameter("inptotalEgreso");  } catch (ServletException paramEx) { ex = paramEx; }     data.cPeriodId = vars.getStringParameter("inpcPeriodId");     data.inPayment = vars.getStringParameter("inpinPayment", "N");     data.dateacct = vars.getStringParameter("inpdateacct");     data.noCDoctypeId = vars.getStringParameter("inpnoCDoctypeId");     data.noCDoctypeIdr = vars.getStringParameter("inpnoCDoctypeId_R");     data.ispago = vars.getRequiredInputGlobalVariable("inpispago", windowId + "|Ispago", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.noRolPagoProvisionId = vars.getRequestGlobalVariable("inpnoRolPagoProvisionId", windowId + "|NO_Rol_Pago_Provision_ID"); 
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strNO_Rol_Pago_Provision_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/atrums/nomina/RoldeProvisiones/RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677", false, "document.frmMain.inpnoRolPagoProvisionId", "grid", "..", "".equals("Y"), "RoldeProvisiones", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Relation.html", "RoldeProvisiones", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strNO_Rol_Pago_Provision_ID, TableSQLData tableSQL)
    ...
    RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strNO_Rol_Pago_Provision_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.set("", Utility.getDefault(this, vars, "Processed", "N", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField), Utility.getDefault(this, vars, "Total_Ingreso", "0", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "IN_Payment", "N", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "em_ne_num_contrato", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.selectDef44057D41DF18403D8D3853403E452D2B_0(this, Utility.getDefault(this, vars, "Createdby", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField)), Utility.getDefault(this, vars, "Total_Neto", "0", "41844ED4F6D346868D4B5D5F1D4AA14D", "0", dataField), Utility.getDefault(this, vars, "Updatedby", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.selectDef584B0B2374BB42A5AB1176EB27F0B063_1(this, Utility.getDefault(this, vars, "Updatedby", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField)), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.selectDef64196704CBB64C56B398440A16A42DD5_2(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField)), Utility.getDefault(this, vars, "Ispago", "@IsSOTrx@", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField), Utility.getDefault(this, vars, "NO_C_Doctype_ID", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "Dateacct", "@#Date@", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "Docstatus", "BR", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "Docaccionno", "CO", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "31D050E5C2D843B99AD7E9470D9E8579", Utility.getDefault(this, vars, "Docaccionno", "CO", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "31D050E5C2D843B99AD7E9470D9E8579", Utility.getDefault(this, vars, "Docaccionno", "CO", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField))), Utility.getDefault(this, vars, "Documentno", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "Payment", "N", "41844ED4F6D346868D4B5D5F1D4AA14D", "N", dataField), Utility.getDefault(this, vars, "NO_Area_Empresa_ID", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), "Y", Utility.getDefault(this, vars, "C_Doctype_ID", "", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.selectDefC708EC749EE04D2E9D1245034DCFF2A7(this, Utility.getContext(this, vars, "AD_ORG_ID", "41844ED4F6D346868D4B5D5F1D4AA14D"), Utility.getContext(this, vars, "AD_CLIENT_ID", "41844ED4F6D346868D4B5D5F1D4AA14D")), Utility.getDefault(this, vars, "Total_Egreso", "0", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "41844ED4F6D346868D4B5D5F1D4AA14D", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/atrums/nomina/RoldeProvisiones/RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/atrums/nomina/RoldeProvisiones/RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpnoRolPagoProvisionId", "", "..", "".equals("Y"), "RoldeProvisiones", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strNO_Rol_Pago_Provision_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Relation.html", "RoldeProvisiones", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Relation.html", strReplaceWith);
...
comboTableData = new ComboTableData(vars, this, "18", "NO_C_Doctype_ID", "170", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("noCDoctypeId"):dataField.getField("noCDoctypeId")));
xmlDocument.setData("reportNO_C_Doctype_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "RoldeProvisiones2407AED87B05460DBD174C5F8EF29677_Edition.html");
...
comboTableData = null;
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (RoldeProvisiones2407AED87B05460DBD174C5F8EF29677Data.getCurrentDBTimestamp(this, data.noRolPagoProvisionId).equals(
  ...
  public String getServletInfo() {
    return "Servlet RoldeProvisiones2407AED87B05460DBD174C5F8EF29677. This Servlet was made by Wad constructor";
