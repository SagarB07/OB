...
xmlDocument.setParameter("EM_Re_Addtransactions_BTNname", Utility.getButtonName(this, vars, "14BCB17E150A4B33A5702DABB8E3C2CE", "EM_Re_Addtransactions_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Re_Addtransactions = org.openbravo.erpCommon.utility.Utility.isModalProcess("86A4C70458F84D8C90B32BC407EAF333"); 
xmlDocument.setParameter("EM_Re_Addtransactions_Modal", modalEM_Re_Addtransactions?"true":"false");
xmlDocument.setParameter("em_dp_addtransactions_BTNname", Utility.getButtonName(this, vars, "262D97F99848486AAB80A978B8C21D0A", "em_dp_addtransactions_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalem_dp_addtransactions = org.openbravo.erpCommon.utility.Utility.isModalProcess("E0B9741404A94BCA857F5BEA17C7842B"); 
xmlDocument.setParameter("em_dp_addtransactions_Modal", modalem_dp_addtransactions?"true":"false");
xmlDocument.setParameter("EM_Atecdp_Addtrs_BTNname", Utility.getButtonName(this, vars, "772B02BBB3B6461EB5F4A77CD6B25C3E", "EM_Atecdp_Addtrs_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Atecdp_Addtrs = org.openbravo.erpCommon.utility.Utility.isModalProcess("1BE8603A3A874C8DA63963250FADB0AB"); 
xmlDocument.setParameter("EM_Atecdp_Addtrs_Modal", modalEM_Atecdp_Addtrs?"true":"false");
xmlDocument.setParameter("EM_Atecdp_Reconcile_BTNname", Utility.getButtonName(this, vars, "D13BEE4927E6436FBA06330D76494359", "EM_Atecdp_Reconcile_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Atecdp_Reconcile = org.openbravo.erpCommon.utility.Utility.isModalProcess("514EF30BB53549B19596C5D725A5BDAD"); 
xmlDocument.setParameter("EM_Atecdp_Reconcile_Modal", modalEM_Atecdp_Reconcile?"true":"false");
