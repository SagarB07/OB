...
/**
 * Entity class for entity NO_RptCargasFamiliares (stored in table NO_rpt_cargas_familiares_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class noRptCargasFamiliaresV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "NO_rpt_cargas_familiares_v";
    public static final String ENTITY_NAME = "NO_RptCargasFamiliares";
    ...
    public String getTipoCarga() {
        return (String) get(PROPERTY_TIPOCARGA);
    }

    public void setTipoCarga(String tipoCarga) {
        set(PROPERTY_TIPOCARGA, tipoCarga);
    }

    public String getGenero() {
        return (String) get(PROPERTY_GENERO);
    }

    public void setGenero(String genero) {
        set(PROPERTY_GENERO, genero);
    }

    public Long getEdad() {
        return (Long) get(PROPERTY_EDAD);
    }
