...
/**
 * Entity class for entity no_tipo_ing_egr_acct (stored in table no_tipo_ing_egr_acct).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class noTipoIngEgrAcct extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "no_tipo_ing_egr_acct";
    public static final String ENTITY_NAME = "no_tipo_ing_egr_acct";
