...
/**
 * Entity class for entity no_registro_gasto (stored in table no_registro_gasto).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class noRegistroGasto extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "no_registro_gasto";
    public static final String ENTITY_NAME = "no_registro_gasto";
