...
/**
 * Entity class for entity no_registra_quincena (stored in table no_registra_quincena).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class noRegistraQuincena extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "no_registra_quincena";
    public static final String ENTITY_NAME = "no_registra_quincena";
    ...
    public static final String PROPERTY_AADIRANTICIPO = "aadirAnticipo";
    public static final String PROPERTY_NOREGISTRAQUINCLINELIST = "noRegistraQuincLineList";

    public noRegistraQuincena() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSED, false);
        setDefaultValue(PROPERTY_AADIRANTICIPO, true);
    ...
    public Boolean isAadirAnticipo() {
        return (Boolean) get(PROPERTY_AADIRANTICIPO);
    }

    public void setAadirAnticipo(Boolean aadirAnticipo) {
        set(PROPERTY_AADIRANTICIPO, aadirAnticipo);
    }
