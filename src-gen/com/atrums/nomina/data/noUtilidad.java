...
/**
 * Entity class for entity no_utilidad (stored in table no_utilidad).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class noUtilidad extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "no_utilidad";
    public static final String ENTITY_NAME = "no_utilidad";
    ...
    public static final String PROPERTY_UTILIDADTOTAL = "utilidadTotal";
    ...
    public static final String PROPERTY_UTILIDADEMPLEADOS = "utilidadEmpleados";
    public static final String PROPERTY_NOUTILIDADLINEALIST = "noUtilidadLineaList";

    public noUtilidad() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_UTILIDADTOTAL, new BigDecimal(0));
        ...
        setDefaultValue(PROPERTY_PORCENTAJE, (long) 15);
        setDefaultValue(PROPERTY_UTILIDADEMPLEADOS, new BigDecimal(0));
        setDefaultValue(PROPERTY_NOUTILIDADLINEALIST, new ArrayList<Object>());
    }
    ...
    public BigDecimal getUtilidadTotal() {
        return (BigDecimal) get(PROPERTY_UTILIDADTOTAL);
    }

    public void setUtilidadTotal(BigDecimal utilidadTotal) {
        set(PROPERTY_UTILIDADTOTAL, utilidadTotal);
    }
    ...
    public Long getPorcentaje() {
        return (Long) get(PROPERTY_PORCENTAJE);
    }
    ...
    public BigDecimal getUtilidadEmpleados() {
        return (BigDecimal) get(PROPERTY_UTILIDADEMPLEADOS);
    }

    public void setUtilidadEmpleados(BigDecimal utilidadEmpleados) {
        set(PROPERTY_UTILIDADEMPLEADOS, utilidadEmpleados);
    }

    @SuppressWarnings("unchecked")
    public List<noUtilidadLinea> getNoUtilidadLineaList() {
      return (List<noUtilidadLinea>) get(PROPERTY_NOUTILIDADLINEALIST);
    }

    public void setNoUtilidadLineaList(List<noUtilidadLinea> noUtilidadLineaList) {
        set(PROPERTY_NOUTILIDADLINEALIST, noUtilidadLineaList);
    }
