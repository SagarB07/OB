...
/**
 * Entity class for entity ne_perfil_rubro (stored in table ne_perfil_rubro).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class nePerfilRubro extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ne_perfil_rubro";
    public static final String ENTITY_NAME = "ne_perfil_rubro";
    ...
    public List<BusinessPartner> getBusinessPartnerEmNePerfilRubroIdList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMNEPERFILRUBROIDLIST);
    }
