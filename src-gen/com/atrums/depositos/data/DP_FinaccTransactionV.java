 ...
 ************************************************************************
*/
package com.atrums.depositos.data;
...
/**
 * Entity class for entity DP_Finacc_Transaction_v (stored in table dp_finacc_transaction_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class DP_FinaccTransactionV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "dp_finacc_transaction_v";
    public static final String ENTITY_NAME = "DP_Finacc_Transaction_v";
