...
/**
 * Entity class for entity IDT_novedad (stored in table IDT_novedad).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class IdtImportacionDatos extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "IDT_novedad";
    public static final String ENTITY_NAME = "IDT_novedad";
    ...
    public String getCedula() {
        return (String) get(PROPERTY_CEDULA);
    }

    public void setCedula(String cedula) {
        set(PROPERTY_CEDULA, cedula);
    }
