...
/**
 * Entity class for entity CO_BP_RETENCION_VENTA (stored in table CO_BP_RETENCION_VENTA).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class BpRetencionVenta extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "CO_BP_RETENCION_VENTA";
    public static final String ENTITY_NAME = "CO_BP_RETENCION_VENTA";
    ...
    public CO_TipoRetencion getTipoDeRetencin() {
        return (CO_TipoRetencion) get(PROPERTY_TIPODERETENCIN);
    }

    public void setTipoDeRetencin(CO_TipoRetencion tipoDeRetencin) {
