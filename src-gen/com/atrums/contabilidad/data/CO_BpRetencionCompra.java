...
/**
 * Entity class for entity CO_BpRetencionCompra (stored in table co_bp_retencion_compra).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CO_BpRetencionCompra extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "co_bp_retencion_compra";
    public static final String ENTITY_NAME = "CO_BpRetencionCompra";
    ...
    public CO_TipoRetencion getTipoRetencion() {
        return (CO_TipoRetencion) get(PROPERTY_TIPORETENCION);
    }

    public void setTipoRetencion(CO_TipoRetencion tipoRetencion) {
