...
/**
 * Entity class for entity co_Vista_retencion_ventas (stored in table co_retencion_venta_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CoRetencionVentaView extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "co_retencion_venta_v";
    public static final String ENTITY_NAME = "co_Vista_retencion_ventas";
    ...
    public static final String PROPERTY_NODERETENCIN = "noDeRetencin";
    public static final String PROPERTY_RETENCINFUENTE = "retencinFuente";
    public static final String PROPERTY_RETENCINIVA = "retencinIVA";
    public static final String PROPERTY_TOTAL = "total";

    public CoRetencionVentaView() {
    ...
    public String getNoDeRetencin() {
        return (String) get(PROPERTY_NODERETENCIN);
    }

    public void setNoDeRetencin(String noDeRetencin) {
        set(PROPERTY_NODERETENCIN, noDeRetencin);
    }

    public BigDecimal getRetencinFuente() {
        return (BigDecimal) get(PROPERTY_RETENCINFUENTE);
    }

    public void setRetencinFuente(BigDecimal retencinFuente) {
        set(PROPERTY_RETENCINFUENTE, retencinFuente);
    }

    public BigDecimal getRetencinIVA() {
        return (BigDecimal) get(PROPERTY_RETENCINIVA);
    }

    public void setRetencinIVA(BigDecimal retencinIVA) {
        set(PROPERTY_RETENCINIVA, retencinIVA);
    }
